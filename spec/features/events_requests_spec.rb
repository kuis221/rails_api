      ...
      feature 'GET index' do
        ...
        feature 'date ranges box' do
          ...
          scenario 'can filter the events by custom date range selecting start and end dates' do
            ...
            create(:event, campaign: campaign1,
                   start_date: (today - 2.weeks).to_s(:slashes), end_date: (today - 2.weeks).to_s(:slashes))
            create(:event, campaign: campaign2,
                   start_date: today.to_s(:slashes), end_date: today.to_s(:slashes))
            create(:event, campaign: campaign2,
                   start_date: Date.today.beginning_of_week.to_s(:slashes), end_date: Date.today.beginning_of_week.to_s(:slashes))
            create(:event, campaign: campaign3,
                   start_date: today.to_s(:slashes), end_date: today.to_s(:slashes))
            create(:event, campaign: campaign3,
                   start_date: Date.today.end_of_week.to_s(:slashes), end_date: Date.today.end_of_week.to_s(:slashes))
            Sunspot.commit
