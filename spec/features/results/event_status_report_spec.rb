...
feature "Results Event Status Page", js: true, search: true  do
  ...
  feature "as a non admin user", search: false do
    ...
    scenario "should display the event status report for selected campaign and grouping" do
      ...
      area = FactoryGirl.create(:area, name: 'Area 1', company: company)
      ...
      FactoryGirl.create(:goal, goalable: campaign, kpi: Kpi.promo_hours, value: '77')
      FactoryGirl.create(:goal, parent: campaign, goalable: company_user, kpi: Kpi.promo_hours, value: 100)
      FactoryGirl.create(:goal, parent: campaign, goalable: company_user, kpi: Kpi.events, value: 10)
      FactoryGirl.create(:goal, parent: campaign, goalable: area, kpi: Kpi.events, value: 3)
      FactoryGirl.create(:goal, parent: campaign, goalable: area, kpi: Kpi.promo_hours, value: 14)
