...
feature "Results Expenses Page", js: true, search: true  do
  ...
  feature "Event Expenses index", js: true, search: true  do
    ...
    scenario "GET index should display a table with the expenses" do
      ...
      event = FactoryGirl.build(:approved_event, campaign: campaign1, company: @company, start_date: "08/21/2013", end_date: "08/21/2013", start_time: '8:00pm', end_time: '11:00pm', place: FactoryGirl.create(:place, name: 'Place 1'))
    ...
    scenario "clicking on the expense item should redirect the user to the event" do
      Kpi.create_global_kpis
      campaign1.add_kpi(Kpi.expenses)
      event = FactoryGirl.build(:approved_event, campaign: campaign1, company: @company, start_date: "08/21/2013", end_date: "08/21/2013", start_time: '8:00pm', end_time: '11:00pm')
      event.event_expenses.build(name: 'Expense #1 Event #1', event_id: event.id, amount: 10)
      event.save
  ...
  feature "custom filters" do
    ...
    scenario "allows to apply custom filters" do
      FactoryGirl.create(:custom_filter, owner: @company_user, name: 'Custom Filter 1', apply_to: 'results_expenses', filters: 'campaign%5B%5D='+campaign1.to_param+'&user%5B%5D='+user1.to_param+'&event_status%5B%5D=Approved&status%5B%5D=Active')
      FactoryGirl.create(:custom_filter, owner: @company_user, name: 'Custom Filter 2', apply_to: 'results_expenses', filters: 'campaign%5B%5D='+campaign2.to_param+'&user%5B%5D='+user2.to_param+'&event_status%5B%5D=Approved&status%5B%5D=Active')
    ...
    scenario "allows to remove custom filters" do
      FactoryGirl.create(:custom_filter, owner: @company_user, name: 'Custom Filter 1', apply_to: 'results_expenses', filters: 'Filters 1')
      cf2 = FactoryGirl.create(:custom_filter, owner: @company_user, name: 'Custom Filter 2', apply_to: 'results_expenses', filters: 'Filters 2')
      FactoryGirl.create(:custom_filter, owner: @company_user, name: 'Custom Filter 3', apply_to: 'results_expenses', filters: 'Filters 3')
