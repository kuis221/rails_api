...
describe FilterSetting, :type => :model do
  ...
  describe "#filter_settings_for" do
    it "should return the correct array of results depending on stored settings" do
      filter_setting = FactoryGirl.create(:filter_setting, company_user_id: 1, apply_to: 'events', settings: '["campaigns_events_active", "brands_events_active", "brands_events_inactive", "users_events_active"]')
