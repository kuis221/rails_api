  ...
  describe '#create' do
    ...
    describe 'an deactivated user' do
      it 'should not be able to login' do
        ...
        expect(flash[:alert]).to eq('Your user has been deactivated. Please contact <a href="mailto:support@brandcopic.com">support@brandcopic.com</a> if you think this has been in error.')
      end
    end
  end
end
