...
describe CommentsController do
  ...
  describe "POST 'create'" do
    ...
    it "should be able to create a comment for an assigned task and send a SMS to the owner" do
      Timecop.freeze do
        with_resque do
          @company_user.update_attributes({notifications_settings: ['new_comment_sms']}, without_protection: true)
    ...
    it "should be able to create a comment for a unassigned task and send a SMS to the event team members" do
      Timecop.freeze do
        with_resque do
          @company_user.update_attributes({notifications_settings: ['new_team_comment_sms']}, without_protection: true)
