...
describe GoalsController, type: :controller do
  ...
  describe "GET 'edit'" do
    it 'returns http success' do
      goal = create(:goal, goalable: company_user, activity_type_id: activity_type.id)
  ...
  describe "PUT 'update'" do
    ...
    it 'should update an activity type goal for an area in a given campaign' do
      area_goal = create(:goal, goalable: area, activity_type_id: activity_type.id)
      area_goal.save
      expect do
    ...
    it 'should update an activity type goal for a company user in a given campaign' do
      user_goal = create(:goal, goalable: company_user, activity_type_id: activity_type.id)
      user_goal.save
      expect do
