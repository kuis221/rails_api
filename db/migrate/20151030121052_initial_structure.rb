class InitialStructure < ActiveRecord::Migration
  def change
    ...
    add_index 'activities', %w(activitable_id activitable_type), name: 'index_activities_on_activitable_id_and_activitable_type', using: :btree
    ...
    add_index 'attached_assets', %w(attachable_type attachable_id), name: 'index_attached_assets_on_attachable_type_and_attachable_id', using: :btree
    ...
    add_index 'brand_portfolios_brands', %w(brand_id brand_portfolio_id), name: 'brand_portfolio_unique_idx', unique: true, using: :btree
    ...
    add_index 'contact_events', %w(contactable_id contactable_type), name: 'index_contact_events_on_contactable_id_and_contactable_type', using: :btree
    ...
    add_index 'entity_forms', %w(entity company_id), name: 'index_entity_forms_on_entity_and_company_id', unique: true, using: :btree
    ...
    add_index 'form_field_options', %w(form_field_id option_type), name: 'index_form_field_options_on_form_field_id_and_option_type', using: :btree
    ...
    add_index 'form_field_results', %w(form_field_id resultable_id resultable_type), name: 'idx_ff_res_on_form_field_id_n_resultable_id_n_resultable_type', unique: true, using: :btree
    ...
    add_index 'form_field_results', %w(resultable_id resultable_type form_field_id), name: 'index_ff_results_on_resultable_and_form_field_id', using: :btree
    add_index 'form_field_results', %w(resultable_id resultable_type), name: 'index_form_field_results_on_resultable_id_and_resultable_type', using: :btree
    ...
    add_index 'form_fields', %w(fieldable_id fieldable_type), name: 'index_form_fields_on_fieldable_id_and_fieldable_type', using: :btree
    ...
    add_index 'goals', %w(goalable_id goalable_type), name: 'index_goals_on_goalable_id_and_goalable_type', using: :btree
    ...
    add_index 'memberships', %w(memberable_id memberable_type), name: 'index_memberships_on_memberable_id_and_memberable_type', using: :btree
    add_index 'memberships', %w(parent_id parent_type), name: 'index_memberships_on_parent_id_and_parent_type', using: :btree
    ...
    add_index 'placeables', %w(placeable_id placeable_type), name: 'index_placeables_on_placeable_id_and_placeable_type', using: :btree
    ...
    add_index 'report_sharings', %w(shared_with_id shared_with_type), name: 'index_report_sharings_on_shared_with_id_and_shared_with_type', using: :btree
    ...
    add_index 'teamings', %w(team_id teamable_id teamable_type), name: 'index_teamings_on_team_id_and_teamable_id_and_teamable_type', unique: true, using: :btree
    add_index 'teamings', ['team_id'], name: 'index_teamings_on_team_id', using: :btree
    add_index 'teamings', %w(teamable_id teamable_type), name: 'index_teamings_on_teamable_id_and_teamable_type', using: :btree
    ...
    add_index 'venues', %w(company_id place_id), name: 'index_venues_on_company_id_and_place_id', unique: true, using: :btree
    ...
    create_table 'views_for_data_extracts', force: :cascade do |_t|
    end
