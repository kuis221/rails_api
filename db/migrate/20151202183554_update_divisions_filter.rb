class UpdateDivisionsFilter < ActiveRecord::Migration
  ...
  def down
    ...
    # Liberty (Control)
    CustomFilter.where(id: 24).update_all(filters: "area%5B%5D=19&area%5B%5D=88&area%5B%5D=26&area%5B%5D=27&area%5B%5D=28&area%5B%5D=31&area%5B%5D=18&area%5B%5D=36&area%5B%5D=105&area%5B%5D=101&area%5B%5D=6&area%5B%5D=47&area%5B%5D=48&area%5B%5D=63&area%5B%5D=54&area%5B%5D=103&area%5B%5D=56")
  end
end
