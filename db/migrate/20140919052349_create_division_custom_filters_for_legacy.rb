class CreateDivisionCustomFiltersForLegacy < ActiveRecord::Migration
  def up
    category = CustomFiltersCategory.create(name: 'Divisions', company_id: 2)
    category.custom_filters.create(name:  'American (SWS Open)',
                        apply_to:  'visits',
                        ...
                        owner_id:  2,
                        owner_type:  'Company')
    category.custom_filters.create(name:  'Continental',
                        apply_to:  'visits',
                        group: 'Divisions',
                        ...
                        owner_id:  2,
                        owner_type:  'Company')
    category.custom_filters.create(name:  'Liberty (Control)',
                        apply_to:  'visits',
                        group: 'Divisions',
