module Results
  module DataExtractHelper
    ...
    def render_descripcion_available_field(field, source, title)
      desc = "<p class=\"description-available-field\">#{I18n.t("data_exports.descriptions.#{source}.#{field}", default: title.humanize)}</p>"
    end
  end
end
