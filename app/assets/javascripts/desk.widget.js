...
(function () {
    ...
    (function () {
        ...
        DESK.Widget.prototype = function () {
            ...
            var chat_sprite_path = "http://noviggo.com/launch_chat_sprite.png";
            var email_sprite_path = "http://noviggo.com/launch_email_sprite.png";
            ...
            return {
                ...
                _buildBaseButton: function () {
                    ...
                    action_path += "?" + params;
                    if (!show_disabled) {
                        if (this._widgetDisplayMode == 0) result = '              <a href="#"               class="a-desk-widget a-desk-widget-' + this._type + '"               style="text-decoration:none;width:65px;display:inline-block;min-height:22px;background: url(' + sprite_path + ') no-repeat scroll 0 0px transparent;"               onmouseover="this.style.backgroundPosition=\'0 -20px\'"               onmouseout="this.style.backgroundPosition=\'0 0px\'"               onclick="window.open(\'' + this._base_url + action_path + "', 'assistly_chat','resizable=1, status=0, toolbar=0,width=" + this._widgetPopupWidth + ",height=" + this._widgetPopupHeight + "')\">&nbsp;</a>";
                        if (this._widgetDisplayMode == 1) result = '              <a href="' + this._base_url + action_path + '"               class="a-desk-widget a-desk-widget-' + this._type + '"               style="text-decoration:none;width:65px;display:inline-block;min-height:22px;background: url(' + sprite_path + ') no-repeat scroll 0 0px transparent;"               onmouseover="this.style.backgroundPosition=\'0 -20px\'"               onmouseout="this.style.backgroundPosition=\'0 0px\'"               >&nbsp;</a>'
