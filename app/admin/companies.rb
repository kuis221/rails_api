  ...
  form do |f|
    ...
    f.inputs name: "Notifications Settings", for: :settings do |settings_form|
      settings_form.input :event_alerts_policy,
        ...
        collection: [
          ['Event Team', Notification::EVENT_ALERT_POLICY_TEAM.to_i, {checked: f.object.event_alerts_policy == Notification::EVENT_ALERT_POLICY_TEAM.to_i}],
          ['All users', Notification::EVENT_ALERT_POLICY_ALL.to_i, {checked: f.object.event_alerts_policy == Notification::EVENT_ALERT_POLICY_ALL.to_i}]
        ]
    end
    f.actions
  end
