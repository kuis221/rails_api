ActiveAdmin.register SatisfactionSurvey do
  ...
  index do
    ...
    column :role, sortable: 'roles.name' do |survey|
      survey.company_user.role_name
    end
  ...
  controller do
    def scoped_collection
      resource_class.joins(company_user: [:user, :company, :role]).includes(company_user: [:user, :company, :role])
    end
  end
end
