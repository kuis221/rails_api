class Api::V1::UsersController < Api::V1::FilteredController
  ...
  * _ba_documents_: Can see a list brand ambassadors documents/folders
  ...
  def user_permissions
    ...
    permissions.push 'events_view_unsubmitted_data' if can?(:view_unsubmitted_data, Event)
    permissions.push 'events_view_submitted_data' if can?(:view_submitted_data, Event)
    permissions.push 'events_view_approved_data' if can?(:view_approved_data, Event)
    permissions.push 'events_view_rejected_data' if can?(:view_rejected_data, Event)
    permissions.push 'events_edit_unsubmitted_data' if can?(:edit_unsubmitted_data, Event)
    permissions.push 'events_edit_submitted_data' if can?(:edit_submitted_data, Event)
    permissions.push 'events_edit_approved_data' if can?(:edit_approved_data, Event)
    permissions.push 'events_edit_rejected_data' if can?(:edit_rejected_data, Event)
