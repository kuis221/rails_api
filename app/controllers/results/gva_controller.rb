class Results::GvaController < ApplicationController
  ...
  helper_method :event_status_stats
  ...
  private
    ...
    def event_status_stats
      ...
      Goal.in(campaign).
        ...
        stats[goal.goalable.name] = {goal: goal.value, scheduled: scheduled, executed: executed, remaining: goal.value - executed}
      end
      stats
    end
